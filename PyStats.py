...
class VisualWrapper():
    ...
    def get_quickstat(self):
        ...
        self.quick = Align(Panel(Align(self.quick_md, align='center'), title='Quick Stat', title_align='center', width=1000), align='left', style='black')#Can Change border style here by changing style
        #print(self.quick)
        return self.quick
